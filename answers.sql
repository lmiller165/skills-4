...
WHERE customer_id IN
  (SELECT id FROM customers
   WHERE fname = 'Jane' AND lname = 'Doe');
...
WHERE o.num_cupcakes > 100 OR o.num_cupcakes = 100
GROUP BY email
ORDER BY email DESC;
...
JOIN cupcakes AS cc ON o.cupcake_id = cc.id
WHERE cc.name = 'funfetti' AND o.processed='true'
